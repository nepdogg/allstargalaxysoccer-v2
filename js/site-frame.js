...
export function mountFooter(site){
 ...
 host.innerHTML=`<div class="footer-inner"><section class="footer-brand-block"><div class="footer-brand-line"><img class="footer-xitlali-logo" src="${site.xitlaliLogo||'assets/images/logos/xitlali-media-logo.png'}" alt="Xitlali Media"><div><strong>${site.footer.credit}</strong><small>Preserving every game, player, and memory.</small></div></div></section><nav class="footer-links" aria-label="Footer navigation">${links}</nav><div class="footer-social">${socials}</div><div class="footer-contact-row"><a class="footer-contact" href="mailto:${email}">✉ Contact Administrator</a></div><div class="footer-divider"></div><div class="footer-meta"><span class="footer-copyright"><span>© 2026</span><img class="footer-mini-logo" src="${site.logo}" alt=""><span>Allstar Galaxy</span></span><small>Allstar Galaxy V${site.version||'2.9.0'} • Section Color Design System • GitHub Pages</small></div></div>`;
}
